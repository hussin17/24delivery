...
use App\Http\Controllers\Api\V1\Vendor\DeliveryManController;
...
Route::group(['namespace' => 'Api\V1', 'middleware' => 'localization'], function () {
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware' => ['vendor.api']], function () {
        ...
        Route::group(['prefix' => 'delivery-man'], function () {
            ...
            Route::get('list', [DeliveryManController::class, 'list']);
            Route::get('preview', [DeliveryManController::class, 'preview']);
            Route::get('status', [DeliveryManController::class, 'status']);
            Route::post('update/{id}', [DeliveryManController::class, 'update']);
            Route::delete('delete', [DeliveryManController::class, 'delete']);
            Route::post('search', [DeliveryManController::class, 'search']);
        });
        // Food
        ...
        Route::group(['prefix' => 'pos'], function () {
            ...
            Route::post('customer_store', [POSController::class, 'customer_store']);
            Route::get('area_blocks', [POSController::class, 'getAreaBlocks']);
            Route::get('blocks', [ZoneController::class, 'get_blocks']);
            Route::get('get_deliveryPrice', [ZoneController::class, 'get_deliveryPrice']);
            Route::get('get_last_deliveries', [POSController::class, 'getAcceptedDelivery']);
        });
    ...
    Route::group(['middleware' => ['module-check']], function () {
        ...
        Route::group(['prefix' => 'customer', 'middleware' => 'apiGuestCheck'], function () {
            Route::group(['prefix' => 'order'], function () {
                ...
                Route::get('get_deliveryPrice', [ZoneController::class, 'getdeliveryPriceCustomer']);
            });
    ...
    Route::get('autosuggestionmap/{search}', [ConfigController::class, 'autosuggestionmap']);
});
