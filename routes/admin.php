...
use App\Http\Controllers\Admin\CityWiseController;
use App\Http\Controllers\Admin\BlockController;
use App\Http\Controllers\Admin\BusinessSettingsController;
use App\Http\Controllers\Admin\KmWiseController;
...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'store', 'as' => 'store.'], function () {
            ...
            Route::get('get-account-data/{store}', [VendorController::class, 'get_account_data'])->name('store-filter');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            ...
            Route::POST(
                ...
                [BusinessSettingsController::class, 'update_react_landing_page_settings']
            ...
            // KM Wise <
            Route::resource('kms', KmWiseController::class);
        });
