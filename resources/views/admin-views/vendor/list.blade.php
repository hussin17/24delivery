    ...
    <div class="content container-fluid">
        ...
        <div class="row g-3 mb-3">
                ...
                <div class="resturant-card card--bg-1">
                    @php
                        $total_store = \App\Models\Store::whereHas('vendor', function ($query) {
                            ...
                            ->count();
                    @endphp
                    @php $total_store = isset($total_store) ? $total_store : 0 @endphp
                ...
                <div class="resturant-card card--bg-2">
                    @php
                        $active_stores = \App\Models\Store::where(['status' => 1])
                            ...
                            ->count();
                    @endphp
                    @php $active_stores = isset($active_stores) ? $active_stores : 0 @endphp
                ...
                <div class="resturant-card card--bg-3">
                    @php
                        $inactive_stores = \App\Models\Store::whereHas('vendor', function ($query) {
                            ...
                            ->count();
                    @endphp
                    @php $inactive_stores = isset($inactive_stores) ? $inactive_stores : 0 @endphp
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="resturant-card card--bg-4">
                    @php
                        $data = \App\Models\Store::where('created_at', '>=', now()->subDays(30)->toDateTimeString())
                            ->where('module_id', Config::get('module.current_module_id'))
                            ->count();
                    @endphp
        ...
        <ul class="transaction--information text-uppercase">
            <li class="text--info">
                ...
                <div>
                    @php $total_transaction = \App\Models\OrderTransaction::where('module_id', Config::get('module.current_module_id'))->count() @endphp
                    @php $total_transaction = isset($total_transaction) ? $total_transaction : 0 @endphp
            ...
            <li class="text--success">
                ...
                <div>
                    @php $comission_earned = \App\Models\AdminWallet::sum('total_commission_earning') @endphp
                    @php $comission_earned = isset($comission_earned) ? $comission_earned : 0 @endphp
            ...
            <li class="text--danger">
                <i class="tio-atm"></i>
                <div>
                    @php $store_withdraws = \App\Models\WithdrawRequest::where(['approved' => 1])->sum('amount') @endphp
                    @php $store_withdraws = isset($store_withdraws) ? $store_withdraws : 0 @endphp
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                        ...
                                        <a class="btn action-btn btn--warning btn-outline-warning"
                                            href="{{ route('admin.store.blocks.index', ['store_id' => $store->id]) }}"
                                            title="{{ translate('messages.view') }}">
                                            <img src="{{ asset('public/assets/admin/img/zone.png') }}" class="w--26"
                                                alt="">
                                        </a>
                                        {{-- KM Config --}}
                                        <a class="btn action-btn btn--warning btn-outline-warning"
