...
@section('content')
                    ...
                    <h1 class="page-header-title">
                        ...
                        <span>
                            {{ translate('messages.cities_list') }} <span class="badge badge-soft-dark ml-2"
                                id="foodCount">{{ $cityWise->total() }}</span>
                        </span>
                    </h1>
                </div>
            </div>
        ...
        <div class="card">
                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="d-flex flex-wrap flex-row p-2 add--city-btn">
                        <button class="btn btn--primary" data-toggle="modal"
                            data-target="#add-city">{{ translate('messages.add_new_city') }}</button>
                    </div>
                </div>
                <!-- End Row -->
            </div>
            ...
            <div class="table-responsive datatable-custom" id="table-div">
                <table id="datatable"
                    ...
                    <tbody id="set-rows">
                        @foreach ($cityWise as $key => $item)
                            <tr>
                                <td>{{ $key + $cityWise->firstItem() }}</td>
                                <td>
                                    {{ Str::limit($item->city) }}
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn--container justify-content-center">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ route('admin.business-settings.city_wise.update', $item->id) }}"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="store_id" class="input-label">
                                                                            {{ translate('select_store') }}
                                                                            <span
                                                                                class="input-label-secondary text-danger">*</span>
                                                                        </label>
                                                                        <select id="store_id" type="text"
                                                                            name="store_id" class="form-control"
                                                                            @selected($item->store_id)
                                                                ...
                                                                <div class="col-12 col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="city_name"
                                                                            class="input-label">{{ translate('city_name') }}
                                                                            <span
                                                                                class="input-label-secondary text-danger">*</span></label>
                                                                        <input id="city_name" type="text"
                                                                            name="city_name" class="form-control"
                                                                            value="{{ $item->city }}"
                                                                            placeholder="{{ translate('messages.city_name') }}"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <form
                                            action="{{ route('admin.business-settings.city_wise.destroy', [$item['id']]) }}"
                ...
                <div class="page-area">
                    <tfoot class="border-top">
                        {!! $cityWise->withQueryString()->links() !!}
                </div>
                @if (count($cityWise) === 0)
    ...
    <div class="modal fade" id="add-city" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ translate('add_new_city') }}</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.business-settings.city_wise.store') }}" method="post"
                        id="product_form">
                        @csrf
                        <div class="row">
                            <div class="col-12 col-lg-6">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <label for="city_name" class="input-label">{{ translate('city_name') }} <span
                                            class="input-label-secondary text-danger">*</span></label>
                                    <input id="city_name" type="text" name="city_name" class="form-control"
                                        value="{{ old('l_name') }}" placeholder="{{ translate('messages.city_name') }}"
                                        required>
                                </div>
                            </div>
                        </div>
