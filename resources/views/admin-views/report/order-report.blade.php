                    ...
                    <table class="table table-borderless middle-align __txt-14px">
                        <thead class="thead-light white--space-false">
                            <tr>
                                ...
                                <th class="border-top border-bottom">{{ translate('messages.price_from_customer') }}</th>
                                ...
                                <th class="border-top border-bottom">{{ translate('messages.charge_way') }}</th>
                            ...
                            @foreach ($orders as $key => $order)
                                <tr class="status-{{ $order['order_status'] }} class-all">
                                    ...
                                    <td>
                                        <div class="text-right mw--85px">
                                            <div>
                                                {{ \App\CentralLogics\Helpers::number_format_short($order['price_from_customer']) }}
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <span class="badge badge-soft-primary">
                                            {{ $order->store['wiseType'] == 'km' ? translate('messages.km') : translate('messages.blocks') }}
                                        </span>
                                    </td>
