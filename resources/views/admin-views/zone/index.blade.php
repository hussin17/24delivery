        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                @if (Request::query('parent') > 0)
                    <span>
                        {{ translate('messages.Add_New_Blocks') }}
                    </span>
                                ...
                                @if ($language)
                                    ...
                                    <div class="tab-content">
                                        ...
                                        @if (Request::query('parent') > 0)
                                            <div class="form-group lang_form" id="exceptional-form">
                                                <label class="input-label"
                                                    for="exampleFormControlInput1">{{ translate('messages.delivery_price') }}
                                                    ({{ translate('messages.exceptional') }})</label>
                                                <input type="text" name="delivery_price" class="form-control"
                                                    placeholder="{{ translate('messages.Write_a_New_delivery_price') }}"
                                                    maxlength="191">
                                            </div>
                                        @endif
                                    ...
                                    @else
                                        <div class="form-group">
                                            <label class="input-label"
                                                for="exampleFormControlInput1">{{ translate('messages.business_Zone_name') }}</label>
                                            <input type="text" name="name" class="form-control"
                                                placeholder="{{ translate('messages.Write_a_New_Business_Zone_Name') }}"
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                @endif
                                @if ($config && $config['status'] == 1 && Request::query('parent') == 0)
                                    <th class="border-0">{{ translate('messages.cash_on_delivery') }}</th>
                                @endif
                                @if ($offline_payment && $offline_payment == 1 && Request::query('parent') == 0)
                        ...
                        <tbody id="set-rows">
                            ...
                            @foreach ($zones as $key => $zone)
                                ...
                                <tr>
                                    ...
                                    @if ($digital_payment && $digital_payment['status'] == 1 && Request::query('parent') == 0)
                                        <td>
                                        ...
                                        <div class="btn--container justify-content-center">
                                            @if (Request::query('parent') == 0)
                                                <a class="btn action-btn btn--primary btn-outline-primary"
                                                    href="{{ route('admin.business-settings.zone.home', ['parent' => $zone['id'], 'name' => $zone->name]) }}"
                                                    title="{{ translate('messages.blocks') }}">
                                                    <img src="{{ asset('public/assets/admin/img/zone.png') }}"
                                                        class="w--26" alt="">
                                                </a>
                                            @endif

                                            <a class="btn action-btn btn--primary btn-outline-primary"
                                                href="{{ route('admin.business-settings.zone.edit', [$zone['id'], 'parent' => $zone->parent]) }}"
            ...
            <div class="modal-dialog modal-lg warning-modal">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <img src="{{ asset('/public/assets/admin/img/zone-settings-popup-arrow.gif') }}" alt="admin/img"
                            class="w-100">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="text-center mb-20">
                        <img src="{{ asset('/public/assets/admin/img/zone-status-on.png') }}" alt=""
                            class="mb-20">
