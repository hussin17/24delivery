                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    @php($search_delivery_distance = \App\Models\BusinessSetting::where('key', 'search_delivery_distance')->first())
                                    <div class="form-label mb-0">
                                        <label class="text-capitalize" for="search_delivery_distance">
                                            <span>
                                                {{ translate('search_delivery_distance') }} (KM)
                                            </span>

                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="{{ translate('search_delivery_distance') }}"><img
                                                    src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ translate('messages.search_delivery_distance') }}"></span>
                                        </label>
                                        <input type="number" name="search_delivery_distance" class="form-control"
                                            id="search_delivery_distance" min="1"
                                            value="{{ $search_delivery_distance ? $search_delivery_distance->value : 5 }}">
                                    </div>
                                </div>
