 ...
 * @property int|null $max_orders_each_day
 * @property string|null $wiseType
 * @property string|null $transport_way
 * @property int|null $notification_time
 */
...
class Store extends Model
{
    ...
    public function cityWises()
    {
        return $this->hasMany(CityWise::class, 'store_id', 'id');
    }
    ...
    /**
     * Get the vehicle associated with the Store
     *
     * @return \Illuminate\Database\Eloquent\Relations\hasOne
     */
    public function vehicle(): hasOne
    {
        return $this->hasOne(DMVehicle::class, 'id', 'transport_way');
    }
}
