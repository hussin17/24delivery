...
class ZoneRepository implements ZoneRepositoryInterface
{
    ...
    public function getListWhere(string $searchValue = null, array $filters = [], array $relations = [], int|string $dataLimit = DEFAULT_DATA_LIMIT, int $offset = null, string $cond = null): Collection|LengthAwarePaginator
    {
    ...
    {
        $zone = $this->zone->find($id);
        if ($zone->blocks()->exists()) {
            Toastr::warning(translate('messages.please delete blocks'));
            return false;
        } else {
