...
class BusinessSettingsController extends Controller
{
    ...
    public function update_dm(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'enable_store_phone_from_delivery'], [
            'value' => $request['enable_store_phone_from_delivery']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'search_delivery_distance'], [
            'value' => $request['search_delivery_distance']
        ]);
