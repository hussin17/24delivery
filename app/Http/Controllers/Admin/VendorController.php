...
class VendorController extends Controller
{
    ...
    public function view($store_id, $tab = null, $sub_tab = 'cash')
    {
        ...
        if ($tab == 'settings') {
            return view('admin-views.vendor.view.settings', compact('store', 'vehicles'));
        } else if ($tab == 'order') {
    ...
    public function updateStoreSettings(Store $store, Request $request)
    {
        ...
        $store->tax = $request->tax;
        $store->max_orders_each_day = $request->max_orders_each_day;
        $store->wiseType = $request->wiseType;
        $store->transport_way = $request->transport_way;
        $store->notification_time = $request->notification_time;
